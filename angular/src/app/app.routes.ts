...
import { OptimisationPagesComponent } from './components/optimisations-page/optimisations-page.component';
...
export const routes: Routes = [
    ...
    { path: 'optimisation',component:OptimisationPagesComponent}
];
